...
def test_model(model):
    oks = 0
    noks = 0
    with open('../data extractors/test_exons_start_0.txt') as test_file:
...
with open('../data extractors/exons_start_0.txt') as in_file:
    total = []
    for line in in_file:
...
with open('partial_model_coding_to_donor_model2.json', 'w') as out:
